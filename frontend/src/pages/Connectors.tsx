...
// Official multicolor Gmail mark (the white envelope is defined by its colored "M",
// so this reads correctly only on a light chip). viewBox follows the Google brand asset.
...
const CONNECTORS: ConnectorDef[] = [
  {
    ...
    icon: GmailIcon,
    tint: "bg-white ring-1 ring-black/5 dark:ring-white/10",
    state: "available",
    overview: [
