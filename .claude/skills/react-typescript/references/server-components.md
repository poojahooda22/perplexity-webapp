...
> ⚠️ **Reference-only for Lumina.** Lumina is a **Vite SPA** — there is **no RSC /
> App Router / Next.js layer**, so none of this applies to the current code. Keep it
> for the mental model and for the day Lumina adds an SSR/Next.js surface. Lumina's
> data fetching is **100% client-side TanStack Query** — see
> [`data-fetching-tanstack-query.md`](data-fetching-tanstack-query.md).
